      ...
      <div class="col-12 col-md-6 order-md-2 order-first">
        ...
        <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
          ...
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="{{url('/admin/blogs')}}">Blog/News</a></li>
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-12">
                      ...
                      <div class="form-group">
                        ...
                        <option @if($rowData->type == 'Blog') selected @endif value="Blog">Blog</option>
                        <option @if($rowData->type == 'News') selected @endif value="News">News</option>
                        </select>
                    ...
                    <div class="col-md-12">
                      ...
                      <div class="form-group">
                        ...
                        <textarea class="form-control editorBox" placeholder="Enter Description" value="" name="description" id="description">{!!$rowData->description!!}</textarea>
                    ...
                    <div class="col-md-4">
                      ...
                      <div class="form-group">
                        ...
                        <label for="basicInput">Banner (1910 x 350)</label>
...
<script src="{{ asset('public/admin/js/pages/blogs/edit-page.js') }}"></script> 
