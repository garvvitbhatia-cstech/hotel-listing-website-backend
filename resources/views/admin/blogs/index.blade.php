        ...
        <div class="page-title">
            ...
            <div class="row">
                ...
                <div class="col-12 col-md-6 order-md-1 order-last">
                    ...
                    <h3>Blog/News Management</h3>


                    <p class="text-subtitle text-muted">Blog/News list.</p>
            ...
            <div class="card">
               ...
               <!--begin::Card body-->
                ...
                <div class="card-body">
                    ...
                    <a href="{{url('/admin/add-blog')}}" class="btn icon btn-sm btn-outline-success float-end">Add New Blog</a>
