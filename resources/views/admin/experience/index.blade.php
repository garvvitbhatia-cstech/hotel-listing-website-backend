    ...
    <div class="page-title">
        <div class="row">
            <div class="col-12 col-md-6 order-md-1 order-last">
                ...
                <p class="text-subtitle text-muted">Experience list.</p>
            </div>
    ...
    <section class="section">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <a href="{{url('/admin/add-experience')}}" class="btn icon btn-sm btn-outline-success float-end">Add New Experience</a>
            </div>
            <!--end::Card body-->
        </div>
    </section>
...
function filterData(type = null){
	...
	$.ajax({
		...
		url: "{{ url('/admin/experience_paginate') }}",
