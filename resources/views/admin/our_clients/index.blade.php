        ...
        <div class="page-title">
            ...
            <div class="row">
                ...
                <div class="col-12 col-md-6 order-md-1 order-last">
                    ...
                    <h3>Our Clients Management</h3>

                    <p class="text-subtitle text-muted">Clients list.</p>
            ...
            <div class="card">
               ...
               <!--begin::Card body-->
                ...
                <div class="card-body">
                    ...
                    <a href="{{url('/admin/add-our-client')}}" class="btn icon btn-sm btn-outline-success float-end">Add New Client</a>
...
function filterData(type = null){
	...
	$.ajax({
		...
		url: "{{ url('/admin/our_clients_paginate') }}",
