  ...
  <div class="page-title">
    <div class="row">
      <div class="col-12 col-md-6 order-md-1 order-last">
        <h3>Add Our Client</h3>
      </div>
      <div class="col-12 col-md-6 order-md-2 order-first">
        <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
          <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="{{url('/admin')}}">Dashboard</a></li>
            <li class="breadcrumb-item"><a href="{{url('/admin/our-clients')}}">Our Clients</a></li>
            <li class="breadcrumb-item active" aria-current="page">Add Our Client</li>
          </ol>
        </nav>
      </div>
    </div>
              ...
              <div class="row">
                ...
                <div class="col-md-12">
                  <div class="form-group">
                    ...
                    <textarea class="form-control editorBox" placeholder="Enter Description" rows="6" value="" name="description" id="description"></textarea>
                  </div>
                </div>                
                <div class="col-md-4">
                  <div class="form-group">
...
<script>
    let saveDataURL = "{{url('/admin/add-our-client')}}";
    let returnURL = "{{url('/admin/our-clients')}}";
</script> 
<script src="{{ asset('public/admin/js/pages/our_clients/add-page.js') }}"></script> 
@endsection 