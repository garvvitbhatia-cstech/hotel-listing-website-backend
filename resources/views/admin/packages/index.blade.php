  ...
  <div class="page-title">
    ...
    <div class="row">
      ...
      <div class="col-12 col-md-6 order-md-1 order-last">
        ...
        <p class="text-subtitle text-muted">Packages list.</p>
  ...
  <section class="section">
    ...
    <div class="card">      
      ...
      <div class="card-body">         
        ...
        <!---<a href="{{url('/admin/add-package')}}" class="btn icon btn-sm btn-outline-success float-end">Add New Package</a> --->
...
function filterData(type = null){
	...
	$.ajax({
		...
		url: "{{ url('/admin/packages_paginate') }}",
