              ...
              <div class="row">
                ...
                <div class="col-md-6">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" placeholder="Enter Price" value="{!! $rowData->price !!}" name="price" id="price">
...
<script>
    let saveDataURL = "{{url('/admin/edit-package/'.$row_id)}}";
    let returnURL = "{{url('/admin/packages')}}";
</script> 
<script src="{{ asset('public/admin/js/pages/packages/add-page.js') }}"></script> 
