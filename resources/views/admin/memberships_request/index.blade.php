        ...
        <div class="page-title">
            <div class="row">
                <div class="col-12 col-md-6 order-md-1 order-last">
                    <h3>Membership Request Management</h3>
                    <p class="text-subtitle text-muted">Requests list.</p>
                </div>
            ...
            <div class="card">
               <!--begin::Card body-->
                <div class="card-body">
                    ...
                    <a href="{{url('/admin/add-membership-request')}}" class="btn icon btn-sm btn-outline-success float-end">Add New Request</a>
                </div>
                <!--end::Card body-->
            </div>
        </section>
...
function filterData(type = null){
	...
	$.ajax({
		...
		url: "{{ url('/admin/membership_request_paginate') }}",
...
function generatePdf(id){
	$.ajax({
        ...
        type: 'POST',
		data:{id:id},
		url: "{{ url('/admin/generate-pdf') }}",
		success: function(response){
			window.open('https://luxiday.com/admin/storage/pdf/card-'+id+'.pdf', '_blank');
		}
	});
}
</script>
