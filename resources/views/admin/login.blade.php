    ...
    <div class="row h-100">
        ...
        <div class="col-lg-7 d-none d-lg-block">
            ...
            <div id="auth-right">
            	...
            	<div class="auth-logo" style="display: flex;justify-content: center;align-items: center;height:900px;">

                    <!--<a href="{{url('/admin')}}"><img width="" class="img-responsive" src="{{ asset('public/img/home/') }}/logo1.jpeg"></a>-->
        ...
        <div class="col-lg-5 col-12">
            ...
            <div id="auth-left">
                ...
                <form action="#" method="post" id="adminLoginForm">
                    ...
                    <input type="hidden" name="latitude" id="latitude" value="26.902528"/>
                    <input type="hidden" name="longitude" id="longitude" value="75.7727232"/>
