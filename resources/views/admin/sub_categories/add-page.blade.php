              ...
              <div class="row">
                ...
                <div class="col-md-12">
                  <div class="form-group">
                    ...
                    <textarea class="form-control editorBox" placeholder="Enter Description" rows="6" name="description" id="description"></textarea>
                  </div>
                </div>
			        </div>
            </div>
...
<script>
    let saveDataURL = "{{url('/admin/add-sub-category/')}}";
