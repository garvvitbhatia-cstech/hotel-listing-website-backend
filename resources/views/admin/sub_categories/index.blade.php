  ...
  <div class="page-title">
    <div class="row">
      <div class="col-12 col-md-6 order-md-1 order-last">
        ...
        <p class="text-subtitle text-muted">Sub Category list.</p>
      </div>
  ...
  <section class="section">
    <div class="card">      
      ...
      <div class="card-body">         
        ...
        <a href="{{url('/admin/add-sub-category')}}" class="btn icon btn-sm btn-outline-success float-end">Add New Category</a>
      </div>      
      <!--end::Card body-->       
    </div>
  </section>  
...
function filterData(type = null){
    if(type =='search'){$('#searchbuttons').html('Searching..');}
	  $.ajax({
        ...
        url: "{{ url('/admin/sub_categories_paginate') }}",
