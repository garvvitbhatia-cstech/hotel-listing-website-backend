      ...
      <div class="col-12 col-md-6 order-md-2 order-first">
        ...
        <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
          ...
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="{{url('/admin/services')}}">Stories</a></li>
              ...
              <div class="row">
                ...
                <div class="col-md-12">
                  ...
                  <div class="form-group">
                    ...
                    <textarea class="form-control editorBox" placeholder="Enter Description" rows="6" name="description" id="description">{!! $rowData->description !!}</textarea>
                ...
                <div class="col-md-2">
                  ...
                  <div class="form-group">
                    ...
                    <img src="{{URL::asset('public/admin/images/products/')}}/{!! $rowData->icon !!}" style="max-width: 80px;height: auto;">
                ...
                <div class="col-md-2">
                  ...
                  <div class="form-group">
                    ...
                    <img src="{{URL::asset('public/admin/images/products/')}}/{!! $rowData->image !!}" style="max-width: 80px;height: auto;">
              ...
              <div class="row">
                ...
                <div class="col-md-12">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" placeholder="Enter SEO Title" value="{!! $rowData->description !!}" name="seo_title" id="seo_title">
                ...
                <div class="col-md-6">
                  ...
                  <div class="form-group">
                    ...
                    <textarea class="form-control" rows="6" placeholder="Enter SEO Description" name="seo_description" id="seo_description">{!! $rowData->description !!}</textarea>
                ...
                <div class="col-md-6">
                  ...
                  <div class="form-group">
                    ...
                    <textarea class="form-control" rows="6" placeholder="Enter SEO Keywords" name="seo_keyword" id="seo_keyword">{!! $rowData->description !!}</textarea>
...
<script>
    ...
    let saveDataURL = "{{url('/admin/edit-service/'.$row_id)}}";

    let returnURL = "{{url('/admin/services')}}";

</script> 

<script src="{{ asset('public/admin/js/pages/services/edit-page.js') }}"></script> 
