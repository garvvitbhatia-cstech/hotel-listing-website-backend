  ...
  <div class="page-title">
    ...
    <div class="row">
      ...
      <div class="col-12 col-md-6 order-md-1 order-last">
        ...
        <h3>Stories Management</h3>

        <p class="text-subtitle text-muted">Stories list.</p>
  ...
  <section class="section">
    ...
    <div class="card">      
      ...
      <div class="card-body">         
        ...
        <a href="{{url('/admin/add-service')}}" class="btn icon btn-sm btn-outline-success float-end">Add New Service</a> 
...
function filterData(type = null){
	...
	$.ajax({
		...
		url: "{{ url('/admin/services_paginate') }}",
