...
class MembershipController extends Controller {
    ...
    public function listPaginate(Request $request){
        ...
        $query = self::$Memberships->where('status', '!=', 3);
        ...
        return view('/admin/memberships/paginate', compact('records'));
    ...
    public function addPage(Request $request){
        ...
        if ($request->input()){
            ...
            if ($validator->fails()){
                ...
                $record = self::$Memberships->CreateRecord($setData);
                echo json_encode(array('heading' => 'Success', 'msg' => 'Membership added successfully'));
                die;
            }
        }
        return view('/admin/memberships/add-page');
    ...
    public function editPage(Request $request, $row_id){
        ...
        $rowData = self::$Memberships->where(array('id' => $RowID))->first();
        ...
        if ($request->input()){
            ...
            if ($validator->fails()){
                ...
                self::$Memberships->UpdateRecord($setData);

            }

            echo json_encode(array('heading' => 'Success', 'msg' => 'Membership updated successfully'));
        ...
        if (isset($rowData->id)){
            ...
            return view('/admin/memberships/edit-page', compact('rowData', 'row_id'));
